...
# Heading
w2 = Label(root, justify=CENTER, text="Disease Predictor from Symptoms", fg="black", bg="white")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=CENTER, text="Sajithan Krishnarajah", fg="black", bg="white")
